...
if __name__ == '__main__':
    gen_train_audio(Path('data/raw_train'), Path('data/audio_train'))
    gen_train_audio(Path('data/raw_test'),  Path('data/audio_test'))

    # 手工分类
    gen_train_img(Path('data/audio_train'), Path('data/image_win100ms_train'), window_ms=100, every_ms=50, bins=64, length=100, mfcc=False)
    gen_train_img(Path('data/audio_test'),  Path('data/image_win100ms_test'),  window_ms=100, every_ms=50, bins=64, length=100, mfcc=False)

    gen_train_img(Path('data/audio_train'), Path('data/image_mfcc_train'), window_ms=25, every_ms=10, bins=64, length=100, mfcc=True)
    gen_train_img(Path('data/audio_test'),  Path('data/image_mfcc_test'),  window_ms=25, every_ms=10, bins=64, length=100, mfcc=True)